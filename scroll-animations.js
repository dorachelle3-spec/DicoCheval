...
(()=>{
  ...
  const attach=()=>{
    document.querySelectorAll('main > .section').forEach(section=>{
      const target=section.querySelector('.home-preview')||section.querySelector(':scope > .wrap');
      if(!target)return;
